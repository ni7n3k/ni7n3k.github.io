...
// Pano2VR 4.0/3102S
// Filename: minimal pc web.ggsk
// Generated Sal 19. Nis 11:23:47 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._loading.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				w=this.parentNode.offsetWidth;
				this.style.left=(-102 + w/2) + 'px';
				h=this.parentNode.offsetHeight;
				this.style.top=(-135 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -102px;';
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;');
			this._hsimage.appendChild(this._hsimage__img);
			this._hsimage.onmouseover=function () {
				me._hotspot_text.style[domTransition]='none';
				me._hotspot_text.style.visibility='inherit';
				me._hotspot_text.ggVisible=true;
				me._hsimage__img.src=basePath + 'images/hsimage__o.png';
			}
			this._hsimage.onmouseout=function () {
				me._hotspot_text.style[domTransition]='none';
				me._hotspot_text.style.visibility='hidden';
				me._hotspot_text.ggVisible=false;
			...
			this._hotspot_text.ggVisible=false;
			this._hotspot_text.ggUpdatePosition=function() {
				this.style[domTransition]='none';
				this.style.left=(-61 + (119-this.offsetWidth)/2) + 'px';
			}
			hs ='position:absolute;';
			hs+='left: -61px;';
			hs+='top:  30px;';
