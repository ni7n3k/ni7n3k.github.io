...
// Filename: pc minimal.ggsk
// Generated qui abr 21 20:14:26 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._controller.ggLeft=-42;
		this._controller.ggTop=-60;
		...
		this._loading.ggLeft=-108;
		this._loading.ggTop=141;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__imgo.setAttribute('src',basePath + 'images/hsimage__o.png');
			...
			this._hsimage__imga=document.createElement('img');
			this._hsimage__imga.className='ggskin ggskin_svg';
			this._hsimage__imga.setAttribute('src',basePath + 'images/hsimage__a.png');
			this._hsimage__imga.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;');
			this._hsimage__imga['ondragstart']=function() { return false; };
			this._hsimage.appendChild(this._hsimage__imga);
